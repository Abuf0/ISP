...
assign average_pre =  wght_buff[0][0] * array_buff[1][1] + wght_buff[0][1] * array_buff[1][2] + wght_buff[0][2] * array_buff[1][3] + wght_buff[0][3] * array_buff[1][4] + wght_buff[0][4] * array_buff[1][5] +
                      wght_buff[1][0] * array_buff[2][1] + wght_buff[1][1] * array_buff[2][2] + wght_buff[1][2] * array_buff[2][3] + wght_buff[1][3] * array_buff[2][4] + wght_buff[1][4] * array_buff[2][5] +
                      wght_buff[2][0] * array_buff[3][1] + wght_buff[2][1] * array_buff[3][2] + wght_buff[2][2] * array_buff[3][3] + wght_buff[2][3] * array_buff[3][4] + wght_buff[2][4] * array_buff[3][5] +
                      wght_buff[3][0] * array_buff[4][1] + wght_buff[3][1] * array_buff[4][2] + wght_buff[3][2] * array_buff[4][3] + wght_buff[3][3] * array_buff[4][4] + wght_buff[3][4] * array_buff[4][5] +
                      wght_buff[4][0] * array_buff[5][1] + wght_buff[4][1] * array_buff[5][2] + wght_buff[4][2] * array_buff[5][3] + wght_buff[4][3] * array_buff[5][4] + wght_buff[4][4] * array_buff[5][5] ;
...
always_ff@(posedge clk or negedge rstn) begin
    if(~rstn)
        {calout_vld,data_vld_ff1} <= 2'd0;
    else
        {calout_vld,data_vld_ff1} <= {data_vld_ff1,data_vld};
end
